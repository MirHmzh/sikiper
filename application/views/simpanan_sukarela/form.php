    ...
    <div class="card-body">
      ...
      <form class="forms-sample" method="POST">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-12">
            <input type="number" name="nominal" id="input" class="form-control" required="required" value="<?= isset($data->nominal_simp_sukarela) ? $data->nominal_simp_sukarela : '' ?>">
          </div>
        </div>
        <div class="form-group">
        ...
        <?php if (isset($data->id_simp_sukarela)): ?>
          <a href="<?= base_url('simpanansukarela/del/'.$data->id_simp_sukarela) ?>" title="">
            <button type="button" class="btn btn-gradient-danger btn-fw">Hapus</button>
          </a>
        <?php endif ?>
        <a href="<?= base_url('simpanansukarela'); ?>" title="">
